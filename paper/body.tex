...
\midrule
VLMs vs.\ specialist (far) & specialist wins $68\%$ vs.\ camera; all 4 frontier VLMs $\le52\%$ (GPT-5.4 $52$, Opus $44$, Sonnet $36$, Llama-4 $34$) \\
...
fraction of items whose prediction is closer to the ball than the frame centre) all sit at or
below chance: GPT-5.4 $52\%$ (CI $[43,62]$), Claude Opus 4.8 $44\%$ ($[35,53]$), Claude
Sonnet 4.6 $36\%$ ($[28,45]$), Llama-4-Maverick $34\%$ ($[25,42]$; Fig.~\ref{fig:vlm}). Even
GPT-5.4, the strongest, only ties the baseline on median error ($0.354$ vs.\ $0.362$), and
far-bin correlation with the truth is weak ($r_y\le0.29$). VLMs post good medians only on
